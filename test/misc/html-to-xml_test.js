...
describe("html-to-xml", function describe() {
  this.timeout(0);
  ...
  makeTest("should convert html to xml", "should convert xml to html");

  // We reuse the files used for the opposite conversion.
