...
define(function f(require) {
  ...
  var source_txt = require("text!./guiroot_test_data/source.xml");

  var assert = chai.assert;

  var dataRoot = window.parent.document.getElementById("domroot");

  describe("guiroot.nodeToPath", function nodeToPath() {
    it("is equivalent to nodeToPath on a data tree", function test() {
