...
function _genericInsertIntoText(text_node, index, node, clean) {
    ...
    var text_node_at = Array.prototype.indexOf.call(parent.childNodes,
                                                    text_node);
...
function genericInsertText(node, index, text) {
    ...
    while (true) {
        ...
        case Node.ELEMENT_NODE:
            ...
            this.insertNodeAt(node, child ? Array.prototype.indexOf.call(
                node.childNodes, child): 0, text_node);
            node = undefined;
            break work;
        case Node.TEXT_NODE:
