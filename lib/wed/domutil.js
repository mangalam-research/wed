 ...
 */
function nodeAtNextCaretPosition(caret, no_text) {
    var node = caret[0];
    var offset = caret[1];
    ...
    while(!found) {
        ...
        case Node.ELEMENT_NODE:
            ...
            // Note that if node.childNodes.length === 0, the first
            // branch would have been taken. So
            // node.childNodes[offset] will always be defined
            // below. (Would not be true if offset could be negative.)
...
function makePlaceholder() {
    return $("<span class='_placeholder'>&nbsp;&nbsp</span>");
}

exports.getSelectionRange = getSelectionRange;
exports.nodeAtNextCaretPosition = nodeAtNextCaretPosition;
