 ...
 * @throws {Error} If <code>root</code> or <code>node</code> is
 * undefined, if <code>node</code> is an invalid type of node (a gui,
 * placeholder or phantom node), or if <code>node</code> is not a
 * descendant of <code>root</code>
...
function dumpCurrentSelection(msg, win) {
    var range = getSelectionRange(win);
    if (!range)
...
//  LocalWords:  Prepend deleteText jQuery getSelectionRange prev dom
...
// LocalWords:  unclick enterStartTag unlinks startContainer mockup
// LocalWords:  startOffset endContainer endOffset
// LocalWords:  genericInsertIntoText
