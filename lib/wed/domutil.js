 ...
 */
define(/** @lends module:domutil */ function f(require, exports) {
  "use strict";
  ...
  var insertText = genericInsertText.bind({
    ...
    setTextNodeValue: function setTextNodeValue(node, value) {
      node.data = value;
    },
  });
  ...
  function dataFindAll(node, selector) {
    ...
    for (var i = 0; i < found_nodes.length; ++i) {
      ret.push($.data(found_nodes[i], "wed_mirror_node"));
    }
    return ret;
  }
