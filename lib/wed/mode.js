 ...
 * initialized. The mode ould use this to add a toolbar above the
 ...
 * <p>Modes must override this method.</p>
 *
 * @returns {module:transformation~TransformationRegistry} The
 * transformation registry used by this mode.
 */
 ...
 * registry returned by {@link
 * module:mode~Mode#getTransformationRegistry
 ...
 * @returns {Array.<module:transformations~Transformation>} An array
 * of transformations.
 */
Mode.prototype.getTagTransformations = function (type, tag) {
    return this.getTransformationRegistry().getTagTransformations(type, tag);
};
