 ...
 */
define(/** @lends module:mode */ function f(require, exports) {
  "use strict";
   ...
   * @emits module:lib/pubsub#WED_MODE_READY
   */
  Mode.prototype._ready = function _ready() {
   ...
   */
  Mode.prototype.init = function init() {};
   ...
   * the value returned.
   */
  Mode.prototype.getWedOptions = function getWedOptions() {
   ...
   */
  Mode.prototype.getAbsoluteResolver = function getAbsoluteResolver() {
   ...
   * will use.
   */
  Mode.prototype.makeDecorator = function makeDecorator() {
   ...
   * of actions.
   */
  Mode.prototype.getContextualActions = function getContextualActions(
   ...
   */
  Mode.prototype.getStylesheets = function getStylesheets() {
    return [];
  };
   ...
   * content.
   */
  Mode.prototype.nodesAroundEditableContents =
    function nodesAroundEditableContents(element) {
      var start = null;
      var start_ix;
      var end = null;
      var end_ix;
   ...
   */
  // eslint-disable-next-line no-unused-vars
  Mode.prototype.makePlaceholderFor = function makePlaceholderFor(element) {
   ...
   */
  // eslint-disable-next-line no-unused-vars
  Mode.prototype.shortDescriptionFor = function shortDescriptionFor(name) {
    return undefined;
  };
   ...
   */
  Mode.prototype.getValidator = function getValidator() {
    return null;
  };
