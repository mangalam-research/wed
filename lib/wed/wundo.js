...
define(/** @lends module:wundo */ function f(require, exports) {
  "use strict";

  var oop = require("./oop");
  var undoMod = require("./undo");
  ...
  function UndoGroup(desc, editor) {
    undoMod.UndoGroup.call(this, desc);
    this._editor = editor;
    this._caret_as_path_before = this.getDataCaretAsPath();
  }

  oop.inherit(UndoGroup, undoMod.UndoGroup);

  UndoGroup.prototype.undo = function undo() {
    undoMod.UndoGroup.prototype.undo.apply(this, arguments);
    this.setDataCaretAsPath(this._caret_as_path_before);
  };

  UndoGroup.prototype.redo = function redo() {
    undoMod.UndoGroup.prototype.redo.apply(this, arguments);
   ...
   * offset]</code> list.
   */
  UndoGroup.prototype.getDataCaretAsPath = function getDataCaretAsPath() {
   ...
   * offset]</code> list.
   */
  UndoGroup.prototype.setDataCaretAsPath = function setDataCaretAsPath(caret) {
   ...
   */
  UndoGroup.prototype.recordCaretAfter = function recordCaretAfter() {
  ...
  TextUndoGroup.prototype.record = function record() {
    if (this._list.length >= this._limit) {
      throw new Error("TextUndoGroup.record called beyond the limit");
    }
    undoMod.UndoGroup.prototype.record.apply(this, arguments);
    if (this._list.length === this._limit) {
  ...
  function MarkerUndo(msg) {
    undoMod.Undo.call(this, "*** MARKER *** " + msg);
  }

  oop.inherit(MarkerUndo, undoMod.Undo);

  MarkerUndo.prototype.undo = function undo() {};
  MarkerUndo.prototype.redo = function redo() {};
