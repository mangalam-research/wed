 ...
 *
 * @param {Node|jQuery|module:dloc~DLocRoot} root The root of the DOM
 * tree to which this location belongs. If a ``jQuery`` object, the
 * first element of the object is used.
...
function makeDLoc(root, node, offset) {
    ...
    else if (root instanceof DLocRoot) {
        root = root.node;
        $root = $(root);
    }
    else
