 ...
 */
define(/** @lends module:dloc */function f(require, exports) {
  "use strict";
   ...
   */
  DLocRoot.prototype.nodeToPath = function nodeToPath(node) {
   ...
   */
  DLocRoot.prototype.pathToNode = function pathToNode(path) {
    var root = this.node;
    ...
    for (var part_ix = 0; part_ix < parts.length; ++part_ix) {
      var part = parts[part_ix];
      if (/^(\d+)$/.test(part)) {
   ...
   */
  DLoc.prototype.clone = function clone() {
    /* jshint newcap:false */
   ...
   */
  DLoc.prototype.make = function make(node, offset) {
   ...
   */
  DLoc.prototype.toArray = function toArray() {
   ...
   */
  DLoc.prototype.makeRange = function makeRange(other) {
    if (isAttr(this.node)) {
   ...
   */
  DLoc.prototype.isValid = function isValid() {
    var node = this.node;
   ...
   */
  DLoc.prototype.normalizeOffset = function normalizeOffset() {
    var node = this.node;
