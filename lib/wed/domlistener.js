 ...
 *    <dd>
 *
 *      <p>handler($root, $tree, $previous_sibling, $next_sibling,
 *      $element)</p>
 *
 ...
 *      module:domlistener~Listener#addHandler addHandler()} The
 *      <code>$tree</code> parameter contains the node which is at the
 *      root of the tree fragment that was added or removed to trigger
 *      the event. Moreover, the <code>$previous_sibling</code> and
 *      <code>$next_sibling</code> parameters record the siblings of
 *      <code>$tree</code>, <strong>not those of
 *      <code>$element</code></strong>.</p></dd>
 *
    ...
    for (var pair_ix = 0, pair_ix_limit = pairs.length;
        ...
        for (var node_ix = 0, node_ix_limit = nodes.length;
            ...
            for(var target_ix = 0, target_ix_limit = $targets.length;
                ...
                this._callHandler(pair[1], $node, $prev, $next,
