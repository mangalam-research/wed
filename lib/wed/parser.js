...
(function () {
    this.start = function () {
        ...
        if (this._states.length === 0) { // create initial state
            ...
            require(["requirejs/text!" + this.schema], function(x) {
                ...
                me._states = [new State(0, me._tree.newWalker(), me.root, CONTENTS)];
    ...
    this._work = function () {
        ...
        while (true) {
            ...
            var walker = current_state.walker;
            ...
            while (true) {
                ...
                case END_TAG:
                    ...
                    // XXX get rid of wed_state_index_after_start
                    if (element_to_parse !== this.root) {
        ...
        if (this._states.length > 0) {
            ...
            $elements.removeData(
                ["wed_state_index_after_start", "wed_event_index_after", 
                 "wed_event_index_after_start", "wed_event_index_before"]);
            this._states = [new State(0, this._tree.newWalker(), this.root, 
                                      CONTENTS)];
            this._events = [];
            this._part_done = 0;
            this._last_done_shown = 0;
