 ...
 */
define(/** @lends module:guiroot */function f(require, exports) {
  "use strict";
   ...
   */
  GUIRoot.prototype.nodeToPath = function nodeToPath(node) {
    var root = this.node;
   ...
   */
  GUIRoot.prototype.pathToNode = function pathToNode(path) {
    var root = this.node;
    ...
    if (attribute) {
      ...
      if (!found) {
        throw new AttributeNotFound("could not find attribute with name: " +
                                    name);
      }
      parent = domutil.siblingByClass(found, "_attribute_value");
    }
