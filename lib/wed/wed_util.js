...
define(/** @lends module:wed */function f(require, exports) {
  ...
  function boundaryXY(boundary) {
    ...
    while (offset) {
      ...
      // If it is not empty, and offset is at the end of the contents, then
      // there must be something *before* the point indicated by offset. Get a
      // rectangle around that and return the right side as the left value.
      var rects;
      if (child && child.nodeType === Node.ELEMENT_NODE) {
