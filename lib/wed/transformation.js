 ...
 * TBA
 *
 * @param {TBA} data_updater TBA
 * @param {TBA} parent TBA
 * @param {TBA} index TBA
 * @param {TBA} tag_name TBA
 * @param {TBA} attrs TBA
 * @param {TBA} contents TBA
 *
 * @returns {TBA} TBA
 */
 ...
 *
 * @param {TBA} data_updater TBA
 * @param {TBA} start_container TBA
 * @param {TBA} start_offset TBA
 * @param {TBA} end_container TBA
 * @param {TBA} end_offset TBA
 * @param {TBA} element TBA
 * @param {TBA} attrs TBA
 *
