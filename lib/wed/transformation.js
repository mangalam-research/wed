 ...
 * <table border="1">
 *
 * <tr><td>transformation type</td><td><code>node</code> is</td>
 * <td><code>element_name</code> is the name of the</td></tr>
 *
 * <tr><td>insert</td><td>undefined (we insert at caret
 * position)</td><td>element to insert</td></tr>
 *
 ...
 * delete</td></tr>
 *
 * <tr><td>wrap</td><td>undefined (we wrap the current
 * selection)</td><td>wrapping element</td></tr>
 *
 ...
 * transformation. The following fields are reserved by wed.
 *
 * * ``tr``: The transformation object. (This field is reserved but not
 *   always present. Don't count on it.)
 * * ``node``: The node to operate on.
 * * ``element_name``: The element name of an element to add, remove, etc.
 *   (Could be different from the name of the ``node``.
 * * ``e``: The JavaScript event that triggered the transformation, if any.
 *
 *
 */
...
/**
 * A utility for moving data carets.
 *
 * @private
 *
 * @param {module:wed~Editor} editor The editor to which the
 * transformation applies.
 * @param {Array} data_caret The caret position where to move.
 * @param {module:transformation~Transformation} tr The transformation
 * to execute.
 * @param {Event} ev The jQuery event that triggered the transformation.
 */
