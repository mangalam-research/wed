...
define(/** @lends module:transformation */function f(require, exports) {
  "use strict";
  ...
  Transformation.prototype.getDescriptionFor = function getDescriptionFor(data) {
   ...
   */
  Transformation.prototype.execute = function execute(data) {
    data = data || {};
  ...
  function insertElement(data_updater, parent, index, ns, name, attrs) {
    var ownerDocument = (parent.nodeType === Node.DOCUMENT_NODE) ?
