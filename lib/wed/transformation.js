 ...
 * with a desc parameter containing the string "<element_name>". When
 * getDescriptionFor is called, this string is replaced with the
 * actual element name. The handler must take 3 parameters (editor,
 * node, element_name). See generic_tr.js for an example.
 */
