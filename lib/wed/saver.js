 ...
 */
define(/** @lends module:saver */function f(require, exports) {
  "use strict";
  ...
  function Saver(version, data_updater, data_tree) {
    ...
    data_updater.addEventListener("changed", function changed() {
   ...
   */
  Saver.prototype.save = function save(done) {
   ...
   */
  Saver.prototype.getData = function getData() {
    if (browsers.MSIE) {
      return serializer.serialize(this._data_tree.firstChild);
    }

    return this._data_tree.firstChild.outerHTML;
  };
   ...
   *
   */
  Saver.prototype._saveSuccess = function _saveSuccess(autosave,
                                                       saving_generation) {
   ...
   * @emits module:saver~Saver#failed
   */
  Saver.prototype._fail = function _fail(error) {
    this._failed = true;
    if (error) {
      /**
   ...
   * @emits module:saver~Saver#autosaved
   */
  Saver.prototype._autosave = function _autosave() {
    this._autosave_timeout = undefined;
    var me = this;
    function done() {
   ...
   */
  Saver.prototype.setAutosaveInterval = function setAutosaveInterval(interval) {
   ...
   * ``false`` if not.
   */
  Saver.prototype.recover = function recover(done) {
   ...
   */
  Saver.prototype.getModifiedWhen = function getModifiedWhen() {
    if (this._saved_generation === this._current_generation) {
      return false;
    }
   ...
   */
  Saver.prototype.getSavedWhen = function getSavedWhen() {
   ...
   */
  Saver.prototype.getLastSaveKind = function getLastSaveKind() {
