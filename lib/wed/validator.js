...
Validator.prototype._cycle = function () {
    ...
    while (true) {
        ...
        case START_TAG:
            ...
            this._validation_stage = CONTENTS;
            $cur_el.data("wed_event_index_after_start", this._events.length);
            cycle_entered--;
        ...
        case END_TAG:
            ...
            if (cur_el === this.root) {
                ...
                this._setWorkingState(this._errors.length > 0 ? INVALID :
                                      VALID);
                $cur_el.data("wed_event_index_after", this._events.length);
                this.stop();
                this.cycle_entered--;
                return false;
            }
...
Validator.prototype._getWalkerAt = function(container, index) {
    ...
    case Node.TEXT_NODE:
        ...
        event_index =
            prev ? $(prev).data("wed_event_index_after") :
    ...
    case Node.ELEMENT_NODE:
        ...
        event_index = prev ? $(prev).data("wed_event_index_after") :
        ...
        if (prev_sibling &&
            ...
            if (prev_sibling.nodeType === Node.TEXT_NODE)
                this._fireTextEventIfNeeded(prev_sibling, walker, true);
            else if (prev_sibling.classList.contains("_text"))
                this._fireTextEventIfNeeded(prev_sibling.firstChild,
                                            walker, true);
        }
        break;
    default:
