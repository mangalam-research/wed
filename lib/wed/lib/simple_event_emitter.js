 ...
 */
define(/** @lends module:lib/simple_event_emitter */ function f(require,
                                                                exports) {
  "use strict";
   ...
   * the event occurs.
   */
  SimpleEventEmitter.prototype.addEventListener = function addEventListener(
    event_name, listener) {
   ...
   */
  SimpleEventEmitter.prototype.addOneTimeEventListener =
    function addOneTimeEventListener(event_name, listener) {
      var me = function oneTime(ev) {
   ...
   */
  SimpleEventEmitter.prototype.removeEventListener =
    function removeEventListener(event_name, listener) {
      var listeners = this._event_listeners[event_name];
      if (listeners === undefined) {
        return;
      }
   ...
   * removed.
   */
  SimpleEventEmitter.prototype.removeAllListeners =
    function removeAllListeners(event_name) {
   ...
   * anything.
   */
  SimpleEventEmitter.prototype._emit = function _emit(event_name, ev) {
