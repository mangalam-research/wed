/**
 * @module simple_event_emitter
 * @desc A mixin class for objects that can emit events.
 * @author Louis-Dominique Dubeau
 */
define(/** @lends module:simple_event_emitter */ function (require, exports,
                                                           module) {
"use strict";

/**
 * This class is a mixin which adds the glue needed for an object to
 * emit events and other object to listen on these events. This
 * constructor must be called by the classes that use this mixin so
 * that the data structure used by the mixin is added. The class that
 * uses this mixin must call {@link
 * module:simple_event_emitter~SimpleEventEmitter#_emit _emit} to emit
...
/**
 * Adds a listener for an event. The order in which event listener are
 ...
 * undo this addtion at a later time using {@link
 * module:simple_event_emitter~SimpleEventEmitter#removeEventListener
...
/**
 * Removes all listener for a specific event.
 *
