...
(function () {
    this.addEventListener = function (event_name, listener) {
    ...
    this.addOneTimeEventListener =  function (event_name, listener) {
        var me = function (ev) {
            listener(ev);
    ...
    this.removeEventListener = function (event_name, listener) {
        var listeners = this._event_listeners[event_name];
        if (listeners === undefined)
            return; 
