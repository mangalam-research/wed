 ...
 */
define(/** @lends module:lib/pubsub */function (require, exports, module) {
'use strict';
 ...
 */
Topic.prototype.addSub = function (name) {
...
/**
 * Obtains a topic object from the name of the topic. This is required
 * because the underlying implementation does not allow passing
 * objects as topics.
 *
 * @param {string} str The fully qualified name of the topic.
 * @return {module:lib/pubsub~Topic} The topic.
 */
function getTopic(str) {
    return topics_by_string[str];
}
