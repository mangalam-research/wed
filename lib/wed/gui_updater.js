...
define(/** @lends module:gui_updater */ function f(require, exports) {
  "use strict";
   ...
   * event.
   */
  GUIUpdater.prototype._insertNodeAtHandler = function _insertNodeAtHandler(ev) {
    var gui_caret = this.fromDataLocation(ev.parent, ev.index);
    var clone = convert.toHTMLTree(this._gui_tree.ownerDocument, ev.node);
   ...
   * event.
   */
  GUIUpdater.prototype._setTextNodeValueHandler =
   ...
   * event.
   */
  GUIUpdater.prototype._beforeDeleteNodeHandler =
   ...
   * event.
   */
  GUIUpdater.prototype._setAttributeNSHandler =
   ...
   */
  GUIUpdater.prototype.fromDataLocation = function fromDataLocation(loc,
                                                                    offset) {
    var node;
    ...
    return makeDLoc(this._gui_tree, gui_child.parentNode,
                    indexOf(gui_child.parentNode.childNodes, gui_child));
  };
