 ...
 */
define(/** @lends module:savers/ajax */ function f(require, exports) {
  "use strict";
   ...
   */
  AjaxSaver.prototype._failure_wrapper = function _failure_wrapper(fn) {
    return log.wrap(function wrapper(jqXHR) {
      try {
   ...
   * @returns {Function} The wrapped function.
   */
  AjaxSaver.prototype._success_wrapper = function _success_wrapper(fn) {
    return log.wrap(function wrapper() {
      try {
        return fn.apply(undefined, arguments);
      }
      catch (e) {
  ...
  AjaxSaver.prototype._save = function _save(autosave, done) {
    ...
    this._post({
      ...
      data: this.getData(),
               ...
               this._success_wrapper(success.bind(this)),
               "json")
      .fail(this._failure_wrapper(function failed() {
        var error = {
  ...
  AjaxSaver.prototype._recover = function _recover(done) {
    function success(data) {
      var msgs = _get_messages(data);
      if (!msgs) {
        done(false);
   ...
   */
  AjaxSaver.prototype._post = function _post(data, callback, dataType) {
    var headers;
