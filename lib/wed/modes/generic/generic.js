...
define(/** @lends module:modes/generic/generic*/function f(require, exports) {
   ...
   * @private
   */
  GenericMode.prototype._resolveOptions = function _resolveOptions() {
    ...
    if (options && options.meta) {
      ...
      if (typeof meta === "string") {
        ...
        require([meta.path], function loaded(mod) {
   ...
   * @private
   */
  GenericMode.prototype._afterResolved = function _afterResolved() {
    var onReady = function onReady(msg, meta) {
      if (this._meta !== meta) {
        return;
      }
    ...
    this._meta = new MetaClass(this._editor.runtime, this._options.meta.options);
  };

  GenericMode.prototype.init = function init() {
    Mode.prototype.init.apply(this, arguments);
    this._tag_tr = makeTagTr(this._editor);
  };
