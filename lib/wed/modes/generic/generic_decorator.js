...
(function () {
    this._contextMenuHandler = function (at_start, ev, jQthis) {
        ...
        if (node.parentNode !== this._editor.root) {
            ...
            this._editor.validator.possibleAt(
                tree_caret[0],
                tree_caret[1]).forEach(function (ev) {
                    ...
                    for(var tr_ix = 0, tr; (tr = trs[tr_ix]) !== undefined;
                        ...
                        $a.click({'tr': tr,
                                 ...
                                 function (e) {
                                     this._editor.dismissContextMenu();
                                     this._editor.setTreeCaret(tree_caret);
                                     this._editor._fireTransformation(e);
                                 }.bind(this));
                        menu_items.push(
