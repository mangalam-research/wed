 ...
 */
define(/** @lends module:modes/generic/generic_decorator */function f(require,
                                                                      exports) {
  "use strict";
  ...
  GenericDecorator.prototype.addHandlers = function addHandlers() {
    this._domlistener.addHandler(
      "included-element",
      util.classFromOriginalName("*"),
      function includedHandler(root, tree, parent, prev, next, el) {
    ...
    this._domlistener.addHandler(
      "children-changed",
      util.classFromOriginalName("*"),
      function childrenChangedHandler(root, added, removed, previous_sibling,
                                      next_sibling, el) {
    ...
    this._domlistener.addHandler(
      "text-changed",
      util.classFromOriginalName("*"),
      function textChangedHandler(root, el) {
    ...
    this._domlistener.addHandler(
      "attribute-changed",
      util.classFromOriginalName("*"),
      function attributeChangedHandler(root, el) {
        this.elementDecorator(root, el);
      }.bind(this));
  ...
  GenericDecorator.prototype.elementDecorator = function elementDecorator(root,
                                                                          el) {
