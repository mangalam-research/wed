 ...
 */
define(/** @lends module:labelman */function f(require, exports) {
  "use strict";
  ...
  LabelManager.prototype.allocateLabel = function allocateLabel(id) {
   ...
   */
  LabelManager.prototype.idToLabel = function idToLabel(id) {
   ...
   * _labelIndex} to 0.
   */
  LabelManager.prototype.deallocateAll = function deallocateAll() {
    this._idToLabel = {};
    this._labelIndex = 0;
   ...
   * This method must be implemented by child classes.
   */
  LabelManager.prototype._deallocateAllLabels = function _deallocateAllLabels() {
   ...
   */
  LabelManager.prototype.nextNumber = function nextNumber() {
