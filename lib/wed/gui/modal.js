...
<div class="modal" style="position: absolute" tabindex="1">\
  <div class="modal-dialog">\
    ...
    this._$dom.on('click', '.btn', util.eventHandler(function (ev, jQthis) {
        this._$clicked = $(jQthis);
        return true;
    }.bind(this)));

    this._$dom.on('shown.bs.modal.modal',
                  util.eventHandler(this._handleShown.bind(this)));
...
Modal.prototype.modal = function (callback) {
    this._$clicked = undefined;
    var bound = util.eventHandler(handler.bind(this));
