 ...
 */
define(/** @lends module:gui/context_menu */ function f(require, exports) {
  "use strict";
  ...
  function ContextMenu(document, x, y, items, dismiss_callback) {
    ...
    $menu.on("mousedown", function mousedown(ev) {
      ev.stopPropagation();
    });
   ...
   * @private
   */
  ContextMenu.prototype._contents_click_handler =
    function _contents_click_handler(ev) {
      this.dismiss();
      ev.stopPropagation();
      ev.preventDefault();
      return false;
   ...
   * @private
   */
  ContextMenu.prototype._backdrop_click_handler =
    function _backdrop_click_handler() {
      this.dismiss();
      return false;
    };
   ...
   * @protected
   */
  ContextMenu.prototype._render = function _render(items) {
   ...
   * Dismisses the menu.
   */
  ContextMenu.prototype.dismiss = function dismiss() {
    if (this._dismissed) {
      return;
    }
