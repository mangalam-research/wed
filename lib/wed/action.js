 ...
 */
define(/** @lends module:action */ function f(require, exports) {
  "use strict";
  ...
  Action.prototype.execute = function execute(data) {
   ...
   */
  Action.prototype.eventHandler = function eventHandler(e) {
    this.execute(e.data);
    e.preventDefault();
  };
   ...
   * @returns {boolean} False.
   */
  Action.prototype.terminalEventHandler = function terminalEventHandler(e) {
    this.eventHandler(e);
    e.preventDefault();
    e.stopPropagation();
    return false;
   ...
   */
  Action.prototype.getDescription = function getDescription() {
    return this._desc;
  };
   ...
   */
  // eslint-disable-next-line no-unused-vars
  Action.prototype.getDescriptionFor = function getDescriptionFor(data) {
   ...
   */
  Action.prototype.getAbbreviatedDescription =
    function getAbbreviatedDescription() {
   ...
   */
  Action.prototype.getIcon = function getIcon() {
    return this._icon;
  };
   ...
   * presentation.
   */
  Action.prototype.getLabelFor = function getLabelFor(data) {
   ...
   * @returns {boolean}
   */
  Action.prototype.getEnabled = function getEnabled() {
