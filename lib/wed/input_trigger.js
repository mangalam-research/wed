...
function InputTrigger(editor, selector) {
    ...
    editor.$gui_root.on("keydown",
                        util.eventHandler(this._keydownHandler.bind(this)));
    editor.$gui_root.on("keypress",
...
InputTrigger.prototype._keydownHandler = function (e, jQthis) {
...
InputTrigger.prototype._keypressHandler = function (e, jQthis) {
    var caret = this._editor.getCaret();
