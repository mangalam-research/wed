 ...
 */
define(/** @lends module:input_trigger */ function f(require, exports) {
  "use strict";
   ...
   * related to that key.
   */
  InputTrigger.prototype.addKeyHandler = function addKeyHandler(key, handler) {
   ...
   */
  InputTrigger.prototype._keydownHandler = function _keydownHandler(wed_event,
                                                                    e) {
    ...
    if (node_of_interest) {
      ...
      this._key_to_handler.forEach(function forEach(key, handlers) {
   ...
   * @param {Event} e The original DOM event that wed received.
   */
  InputTrigger.prototype._keypressHandler = function _keypressHandler(wed_event,
                                                                      e) {
    var caret = this._editor.getDataCaret(true);
   ...
   */
  InputTrigger.prototype._pasteHandler = function _pasteHandler(wed_event, e,
                                                                caret, data) {
    ...
    this._text_input_key_to_handler.forEach(function forEach(key, handlers) {
      if (key.anyModifier()) {
        return;
