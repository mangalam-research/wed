...
define(/** @lends module:wed */function f(require) {
  ...
  var caretMovement = require("./caret-movement");
  var log = require("./log");
  ...
  EditorP.positionRight = function positionRight(pos) {
    return caretMovement.positionRight(pos,
  ...
  EditorP.positionLeft = function positionLeft(pos) {
    return caretMovement.positionLeft(pos,
                                      this.attributes === "edit",
                                      this.gui_root,
                                      this.mode);
  };
  ...
  EditorP.positionDown = function positionDown(pos) {
    return caretMovement.positionDown(pos,
                                      this.attributes === "edit",
                                      this.gui_root,
                                      this.mode);
  };
