...
define(/** @lends module:wed */function f(require) {
  ...
  EditorP.getSelectionRange = function getSelectionRange() {
    var info = this.getSelectionRangeInfo();
    return info && info.range;
  };

  EditorP.getSelectionRangeInfo = function getSelectionRange() {
    return this._sel_anchor ? this._sel_anchor.makeRange(this._sel_focus)
      : undefined;
  };
  ...
  EditorP._caretPositionOnScreen = function _caretPositionOnScreen() {
    ...
    if (this._caretMark.inDOM) {
      return this._caretMark.getBoundingClientRect();
    }
