 ...
 *
 * Except for the {@link
 * module:tree_updater~TreeUpdater#event:deleteNode deleteNode} event,
 * all events are emitted **after** their corresponding operation is
 * performed on the tree. The {@link
 * module:tree_updater~TreeUpdater#deleteNode deleteNode} event is
 * emitted before its corresponding operation is performed on the
 * tree. This allows recording the node's location before it is
 * removed.
 *
