...
TreeUpdater.prototype.setAttribute = function (node, attribute, value) {
    ...
    this._emit("setAttribute", {node: node, attribute: attribute,
                                value: value});
