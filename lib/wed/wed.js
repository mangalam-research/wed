...
Editor.prototype._refreshFakeCaret = function () {
    ...
    case Node.TEXT_NODE:
        ...
        break;
    case Node.ELEMENT_NODE:
        node.insertBefore(mark, node.childNodes[offset] || null);
        break;
    default:
 ...
 */
Editor.prototype._findCharAt = function (x, y) {
    ...
    if (!min)
        return makeDLoc(this.gui_root, element_at_mouse, 0);
...
Editor.prototype._pointToCharBoundary = function(x, y) {
    ...
    var boundary = this._findCharAt(x, y);
