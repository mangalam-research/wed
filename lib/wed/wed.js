...
<div class="row">\
 ...
 <div id="sidebar" class="col-sm-pull-10 col-lg-2 col-md-2 col-sm-2"/>\
    ...
    // separate.
    var html_tree = convert.toHTMLTree(doc, data_doc.firstChild);
    var frag = doc.createDocumentFragment();
    frag.appendChild(doc.createElement("div"));
    this.data_root = frag.firstChild;
    this.data_root.appendChild(html_tree);
    this.$data_root = $(this.data_root);
    this.gui_root.appendChild(this.data_root.firstChild.cloneNode(true));
...
function boundaryXY(boundary) {
    ...
    if (((node_type === Node.ELEMENT_NODE) && (node.childNodes.length === 0)) ||
        ...
        var parent = node.parentNode;
        return boundaryXY(parent, _indexOf.call(parent.childNodes, node));
    }
