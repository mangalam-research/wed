...
Editor.prototype.dumpCaretInfo = function () {
    ...
    console.log("fake caret", this._fake_caret.node, this._fake_caret.offset);
    console.log("data closest real", $(data_caret.node).closest("._real"));
    console.log("gui closest real", $(this._raw_caret.node).closest("._real"));
...
Editor.prototype._blur = function (ev) {
    if (!this._raw_caret)
        return;
...
Editor.prototype._focus = function (ev) {
...
Editor.prototype._mousedownHandler = log.wrap(function(ev) {
    ...
    if (!$(boundary.node).closest(this.gui_root).length)
        return true;
