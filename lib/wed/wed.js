...
Editor.prototype._postInitialize = log.wrap(function  () {
    ...
    this._$fake_caret.on("mousedown mouseup click",
                         this._caretMouseHandler.bind(this));
...
Editor.prototype._refreshFakeCaret = function () {
    ...
    if (!this._$fake_caret.parent()[0])
        this.$gui_root.before(this._$fake_caret);
...
Editor.prototype._mousemoveHandler = log.wrap(function (e) {
    this._sel_focus = this._pointToCharBoundary(e.pageX, e.pageY);
    ...
    if (!this._prev_sel_focus ||
        ...
        domutil.focusNode(this._sel_focus.node);
        sel.removeAllRanges();
        sel.addRange(rr.range, rr.reversed);
        this._prev_sel_focus = this._sel_focus;
    }
});

Editor.prototype._caretMouseHandler = log.wrap(function (e) {
    if (e.type === "mousedown")
        this._$fake_caret.on("mousemove",
                             this._caretMouseHandler.bind(this));
    var old_display = this._$fake_caret.css("display");
    this._$fake_caret.css("display", "none");
    var element_at_mouse =
    ...
    this._$fake_caret.css("display", old_display);
    if (e.type === "mouseup")
        this._$fake_caret.off("mousemove");
});

Editor.prototype._mousedownHandler = log.wrap(function(e) {
    if (e.which === 1) {
        this._sel_anchor = this._pointToCharBoundary(e.pageX, e.pageY);
