...
<div class="row">\
 ...
 <div id="sidebar" class="col-sm-pull-10 col-lg-2 col-md-2 col-sm-2"/>\
    ...
    this.$sidebar = $(doc.getElementById("sidebar"));
  ...
  <span class="wed-save-status label label-default">\
   <i class="icon icon-cloud-upload"></i> <span></span>\
    ...
    this._$modification_status =
        $(this.$sidebar[0].getElementsByClassName(
            'wed-modification-status')[0]);
    this._$save_status = $(this.$sidebar[0].getElementsByClassName(
        'wed-save-status'));
