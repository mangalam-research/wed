 ...
 * @classdesc TBA
 * @constructor
 * @param {module:domlistener~Listener} domlistener TBA
 * @param {module:wed~Editor} editor TBA
 * @param {module:gui_updater~GUIUpdater} gui_updater TBA
*/
 ...
 * @param {TBA} $previous_sibling TBA
 * @param {TBA} $next_sibling TBA
 * @param {TBA} $element TBA
*/
 ...
 * @param {TBA} $root TBA
 * @param {TBA} el TBA
 * @param {TBA} pre_context_handler TBA
 * @param {TBA} post_context_handler TBA
 */
 ...
 * TBA
 * @private
 * @param {TBA} at_start TBA
 * @param {TBA} wed_ev TBA
 * @param {TBA} ev TBA
 * @returns {Boolean} TBA
*/
...
// LocalWords:  unclick enterStartTag lt focusable el sep LocalWords
