...
define(["require", "exports", "wed"], function (require, exports, wed_1) {
    ...
    var GenericDecorator = /** @class */ (function (_super) {
        ...
        GenericDecorator.prototype.addHandlers = function () {
            var _this = this;
            this.domlistener.addHandler("included-element", wed_1.util.classFromOriginalName("*", {}), function (root, tree, parent, prev, next, el) {
            ...
            this.domlistener.addHandler("children-changed", wed_1.util.classFromOriginalName("*", {}), function (root, added, removed, previousSibling, nextSibling, el) {
