                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            if (demo !== undefined) {
                                ...
                                demoModal.setBody("<p>This is a demo of wed. " + demo + "</p> <p>Click <a href='" + this.docLink + "' target='_blank'>this link</a> to see wed's generic help. The link by default will open in a new tab.</p>");
...
in a way not supported by this version of wed.";
            ...
            if (label !== null) {
                ...
                var options = {
                    title: function () {
                        ...
                        // dynamically.
                        if (!_this.preferences.get("tooltips")) {
                            return undefined;
                        }
                ...
                tooltip_1.tooltip($(label), options);
         ...
         */
        Editor.prototype.displayTypeaheadPopup = function (x, y, width, 
            // tslint:disable-next-line:no-any
            placeholder, options, dismissCallback) {
            var _this = this;
            this.editingMenuManager.dismiss();
        ...
        Editor.prototype.caretChange = function (ev) {
            var options = ev.options, caret = ev.caret, prevCaret = ev.prevCaret, manager = ev.manager;
            if (caret === undefined) {
                return;
            }
            ...
            while ((el = this.caretOwners[0]) !== undefined) {
                el.classList.remove("_owns_caret");
            }
            // tslint:disable-next-line:no-conditional-assignment
            while ((el = this.clickedLabels[0]) !== undefined) {
                el.classList.remove("_label_clicked");
            }
            // tslint:disable-next-line:no-conditional-assignment
            while ((el = this.withCaret[0]) !== undefined) {
            ...
            while (node !== this.guiRoot) {
                ...
                if (!node.classList.contains("_placeholder") &&
                    domutil_1.closestByClass(node, "_phantom", root) === null) {
                    steps.unshift("<span class='_gui _label'><span>&nbsp;" + util.getOriginalName(node) + "&nbsp;</span></span>");
                }
