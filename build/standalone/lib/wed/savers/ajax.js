...
define(["require", "exports", "module", "bluebird", "jquery", "../saver"], function (require, exports, module, Promise, $, saver) {
    "use strict";
    ...
    var AjaxSaver = (function (_super) {
        ...
        function AjaxSaver(runtime, version, dataUpdater, dataTree, options) {
            ...
            // pass it to 'If-Match'.
            _this.etag = "\"" + options.initial_etag + "\"";
